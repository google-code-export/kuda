...
var hext = (function(hext) {
	 ...
	 */
	Manometer.prototype.cleanup = function() {
	 ...
	 */
	Manometer.prototype.toOctane = function() {
	 ...
	 *     visible
	 */
	Manometer.prototype.setVisible = function(visible) {
	 ...
	 */
	Manometer.prototype.getValue = function() {
		return this.value;
	};
	 ...
	 */
	Manometer.prototype.setValue = function(value) {
	 ...
	 */
	Manometer.prototype.getLocation = function() {
	 ...
	 */
	Manometer.prototype.setLocation = function(location) {
	 ...
	 */
	Manometer.prototype.getInput = function(inputId) {
		var input = null;
	 ...
	 */
	Manometer.prototype.setInput = function(input) {
		var visible = false;
		var mode;
	 ...
	 * @param {hext.tools.InputId} inputId id of the input to get
	 */
	Manometer.prototype.removeInput = function(inputId) {
		var oldInput = null;
	 ...
	 */
	Manometer.prototype.inputUpdated = function(inputId) {
		switch (inputId) {
			case hext.tools.InputId.UpperLeft:
			case hext.tools.InputId.LowerLeft:
	...
	hemi.makeCitizen(Manometer, 'hext.tools.Manometer', {
		msgs: [hext.msg.input, hext.msg.pressure],
		toOctane: []
	});
