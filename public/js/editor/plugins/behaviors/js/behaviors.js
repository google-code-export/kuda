...
////////////////////////////////////////////////////////////////////////////////
     ...
     * A BehaviorModel
     */
    module.tools.BehaviorModel = module.tools.ToolModel.extend({
		init: function() {
			this._super();
...
////////////////////////////////////////////////////////////////////////////////   
     ...
     */
    module.tools.BehaviorViewDefaults = {
        toolName: 'Behaviors',
     ...
     */
    module.tools.BehaviorView = module.tools.ToolView.extend({
		init: function(options) {
	        var newOpts = jQuery.extend({}, module.tools.BehaviorViewDefaults, 
				options);
	        this._super(newOpts);
...
////////////////////////////////////////////////////////////////////////////////
     ...
     */
    module.tools.BehaviorController = module.tools.ToolController.extend({
		init: function() {
			this._super();
    	},
