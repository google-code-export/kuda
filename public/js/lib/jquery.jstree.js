...
(function ($) {
	$.jstree.plugin("json_data", {
		...
		_fn : {
			/**
			 * Addition by Khang for kuda.hemi
			 * 
			 * @param {Object} obj
			 * @param {Object} position
			 * @param {Object} js
			 * @param {Object} callback
			 * @param {Object} is_loaded
			 * @param {Object} skip_check
			 */
            create_node : function (obj, position, js, callback, is_loaded, skip_check) {
                ...
                if(!js) { js = {}; }
				if(js.json_data) {
					d = this._parse_json(js.json_data).children();
				}
				else {
	                if(js.attr) { d.attr(js.attr); }
	                if(js.state) { d.addClass("jstree-" + js.state); }
...
(function ($) {
	$.jstree.plugin("sort", {
		__init : function () {
			this.get_container()
				// Addition by Erik for kuda.hemi
				.bind("create_node.jstree", $.proxy(function (e, data) {
						var obj = this._get_node(data.rslt.obj);
						obj = obj === -1 ? this.get_container() : obj.parent();
						this.sort(obj);
					}, this))
